 ...
 * TipoVFrame.java
 *
 * Created on 14 de febrero de 2025, 08:20 AM
 */
package ruleasm;
...
public class TipoVFrame extends javax.swing.JInternalFrame
{
    ...
    private void initComponents() {
        ...
        jRBVolarSi = new javax.swing.JRadioButton();
        jRBVolarNo = new javax.swing.JRadioButton();
        ...
        jCBNumR.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2", "3", "4", "8" }));

        jLabel3.setText("Volar");

        jRBVolarSi.setText("Si");
        jRBVolarSi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRBVolarSiActionPerformed(evt);
            }
        });

        jRBVolarNo.setText("No");
        jRBVolarNo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRBVolarNoActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(jRBVolarSi)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(jRBVolarNo))
    ...
    private void BAcepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BAcepActionPerformed
        // TODO add your handling code here:
        objP.NumR = String.valueOf(jCBNumR.getSelectedItem());
        objP.ge=new GuiEvent(BAcep,1);
        objP.myAgent.postGuiEvent(objP.ge);
        this.setVisible(false);     
        
    }//GEN-LAST:event_BAcepActionPerformed

    private void jRBVolarSiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRBVolarSiActionPerformed
        // TODO add your handling code here:
        if(jRBVolarNo.isSelected())
        {
            jRBVolarSi.setSelected(true);
            jRBVolarNo.setSelected(false);
            objP.volar="si";
        }
}//GEN-LAST:event_jRBVolarSiActionPerformed

    private void jRBVolarNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRBVolarNoActionPerformed
        // TODO add your handling code here:
        if(jRBVolarSi.isSelected())
        {
            jRBVolarNo.setSelected(true);
            jRBVolarSi.setSelected(false);
            objP.volar="no";
        }
}//GEN-LAST:event_jRBVolarNoActionPerformed
    ...
    private javax.swing.JRadioButton jRBVolarNo;
    private javax.swing.JRadioButton jRBVolarSi;
